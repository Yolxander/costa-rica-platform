                    ...
                    <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
                        <div className="mt-14 mx-auto max-w-3xl text-center">
                            ...
                            <p className="mt-4 text-lg text-muted-foreground">
                                List your property, receive inquiries, and
                                accept bookings—without high OTA commissions.
                            </p>
                            <Link
                                href="/host/register"
                    ...
                    <section className="border-t px-4 py-16 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-4xl">
                            ...
                            <div className="relative">
                                ...
                                <div
                                    className="absolute top-6 bottom-6 left-1/2 hidden w-0.5 -translate-x-px bg-border md:block"
                                    aria-hidden
                                />
                    ...
                    <section className="border-t bg-muted/20 px-4 py-16 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-2xl text-center">
                            <h2 className="text-2xl font-bold sm:text-3xl">
                                Start receiving direct bookings today
                            </h2>
                            <p className="mt-2 text-muted-foreground">
                                Secure payments · Verified listings · No credit
                                card to start
                            </p>
